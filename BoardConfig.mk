...
include device/htc/msm8660-common/BoardConfig.mk
...
TARGET_GLOBAL_CFLAGS += -DQCOM_HARDWARE $(call cc-option,-mtune=cortex-a9,$(call cc-option,-mtune=cortex-a8)) $(call cc-option,-mcpu=cortex-a9,$(call cc-option,-mcpu=cortex-a8))
TARGET_GLOBAL_CPPFLAGS += -DQCOM_HARDWARE $(call cc-option,-mtune=cortex-a9,$(call cc-option,-mtune=cortex-a8)) $(call cc-option,-mcpu=cortex-a9,$(call cc-option,-mcpu=cortex-a8))
